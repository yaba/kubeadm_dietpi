...
CORES=$(whiptail --inputbox 'Enter the number of cores for the new virtual machine (default: 2):' 8 78 000 --title 'DietPi Installation' 3>&1 1>&2 2>&3)
...
ID=$(whiptail --inputbox 'Enter the ID:' 8 78 2 --title 'DietPi Installation' 3>&1 1>&2 2>&3)
